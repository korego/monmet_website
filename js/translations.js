...
const translations = {
  en: {
    ...
    hero_slide4_subtitle: "Built with premium materials for years of reliable performance",
    hero_slide5_title: "Easy, Universal Installation",
    hero_slide5_subtitle: "Simple to install on most fireplaces — no special tools required",
    
    // CTA Section
    cta_title_line1: "PROUDLY BUILT IN",
    cta_title_line2: "NORTH AMERICA",
    cta_subtitle: "High-performance fireplace fans and blowers with superior quality and prompt service",
    cta_btn_products: "View Products",
    cta_btn_contact: "Contact Us",
    
    // Features
    feature1_title: "CSA & UL Approved",
    feature1_desc: "All blower kits equipped with certified parts meeting industry standards",
    ...
    about_p1: "Monmet Technologies offers a wide range of high-performance gas and wood-burning fireplace fan kits and fireplace blowers, featuring improved heat distribution, whisper-quiet function, and full warranty coverage.",
    about_p2: "Our quality and performance meet or surpass industry standards, with physical quality and dimensional integrity meticulously checked against specifications and technical drawings.",
    ...
    contact_address_text: "6205 chemin St-François<br />Saint-Laurent, QC H4S 1W6",
  ...
  fr: {
    ...
    hero_slide1_subtitle: "Faites circuler l'air chaud uniformément dans toute votre maison",
    ...
    hero_slide4_subtitle: "Fabriqué avec des matériaux de qualité pour des années de performance fiable",
    hero_slide5_title: "Installation Facile et Universelle",
    hero_slide5_subtitle: "Simple à installer sur la plupart des foyers — aucun outil spécial requis",
    
    // CTA Section
    cta_title_line1: "FIÈREMENT FABRIQUÉ EN",
    cta_title_line2: "AMÉRIQUE DU NORD",
    cta_subtitle: "Ventilateurs et souffleurs de foyer haute performance avec qualité supérieure et service rapide",
    cta_btn_products: "Voir les produits",
    cta_btn_contact: "Nous contacter",
    
    // Features
    feature1_title: "Approuvé CSA et UL",
    feature1_desc: "Tous les kits de soufflerie équipés de pièces certifiées conformes aux normes de l'industrie",
    feature2_title: "Garantie Complète",
    feature2_desc: "Garantie d'un an à partir de la date d'expédition sur tous les produits",
    feature3_title: "Silencieux",
    feature3_desc: "Performance supérieure avec un minimum de bruit pour votre confort",
    ...
    about_p1: "Monmet Technologies offre une large gamme de kits de ventilateurs et de souffleurs de foyer à gaz et au bois haute performance, avec une distribution de chaleur améliorée, un fonctionnement silencieux et une couverture de garantie complète.",
    about_p2: "Notre qualité et nos performances répondent ou dépassent les normes de l'industrie, la qualité physique et l'intégrité dimensionnelle étant méticuleusement vérifiées par rapport aux spécifications et aux dessins techniques.",
    about_stat1_value: "100%",
    ...
    product1_desc: "Kits de ventilateurs de foyer et systèmes de soufflerie haute performance des principaux fabricants",
    product1_btn: "Voir les produits",
    product2_title: "Accessoires",
    product2_desc: "Contrôleurs de vitesse, thermostats, supports et composants d'installation",
    product2_btn: "Voir les produits",
    product3_title: "Pièces pour Poêles à Granules",
    product3_desc: "Pièces de rechange et composants pour systèmes de poêles à granules",
    product3_btn: "Voir les produits",
    
    // Testimonials
    testimonials_title: "Histoires de Succès de Nos Clients",
    testimonials_subtitle: "Approuvé par les principaux distributeurs en Amérique du Nord",
    testimonial1_customer: "Martin T.",
    testimonial1_company: "Atlantic Fireplaces Inc.",
    testimonial1_excerpt: "Nous achetons les kits de ventilateurs de Monmet Technologies depuis plus de 6 ans. Leur service a été très professionnel tout en offrant une touche amicale et personnelle...",
    testimonial1_full: "Nous achetons les kits de ventilateurs de Monmet Technologies depuis plus de 6 ans. Leur service a été très professionnel tout en offrant une touche amicale et personnelle. Le service après-vente est excellent avec un représentant toujours disponible pour répondre à nos questions et prendre soin de nos besoins. Nous avons également été très impressionnés par l'attention du département d'expédition à l'emballage - nos kits de ventilateurs arrivent toujours en parfait état. Ils semblent faire un effort supplémentaire qui minimise les retours. Avoir une action rapide et immédiate à nos demandes nous donne un sentiment de confiance que nous sommes entre de bonnes mains.",
    testimonial2_customer: "Sarah L.",
    testimonial2_company: "Northeast HVAC Distributors",
    testimonial2_excerpt: "Monmet Technologies s'est avéré être un partenaire fiable pour notre réseau de distribution. La qualité de leurs produits est toujours excellente, et leur équipe est toujours réactive...",
    ...
    alert_message: "Notre service de courriel est actuellement en cours de configuration.",
